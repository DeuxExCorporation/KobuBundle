...
/**
 * ProtectorasRedesSociales
 *
 * @ORM\Table(name="protectoras_redessociales")
 * @ORM\Entity(repositoryClass="Destiny\KobuBundle\Entity\Repository\ProtectorasRedesSocialesRepository")
 * @UniqueEntity("url")
 */
class ProtectorasRedesSociales
{
	/**
	 * @var integer
	 *
     ...
     *     cascade={"persist"},inversedBy="redesSociales")
     ...
     * @return ProtectorasRedesSociales
     */
